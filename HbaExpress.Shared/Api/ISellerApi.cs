...
public interface ISellerCatalogApi
{
    ...
    /// <summary>Traite une image (détourage IA + fond blanc) avant création ; renvoie l'image traitée (JPEG).</summary>
    Task<Seller_MP_Dashboard.Models.ProductImageUpload> ProcessImageAsync(Seller_MP_Dashboard.Models.ProductImageUpload image);
